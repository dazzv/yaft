              ...
              <div class="blocks " style="margin-bottom:71px">
                <div class="block">
                  <div class="block-text">
                    <p>Пульс</p>
                    <p class="block-value">70 <span class="block-value-about">уд/мин</span></p>
                  </div>
                ...
                <div class="block">
                  <div class="block-text">
                    <p>Сон</p>
                    <p class="block-value">6.23 <span class="block-value-about">час/мин</span></p>
                  </div>
                ...
                <div class="block">
                  <div class="block-text">
                    <p>Температура</p>
                    <p class="block-value">36.6 <span class="block-value-about">&deg;С</span></p>
                  </div>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="block-svg">
                ...
                <div class="block">
                  <div class="block-text">
                    ...
                    <p class="block-value">98<span class="block-value-about">%</span></p>
                  </div>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="block-svg">
                ...
                <div class="block">
                  <div class="block-text">
                    ...
                    <p class="block-value">120/80<span class="block-value-about">мм рт. ст</span></p>
                  </div>
                ...
                <div class="block">
                  <div class="block-text">
                    <p>Уровень шума</p>
                    <p class="block-value">50<span class="block-value-about">децибел</span></p>
                  </div>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" class="block-svg">
